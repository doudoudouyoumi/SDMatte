...
hy_dict = EasyDict(
    ...
    model_kwargs=EasyDict(
        pretrained_model_name_or_path="LongfeiHuang/LiteSDMatte",
        load_weight=False,
        conv_scale=3,
...
model = L(LiteSDMatte)(**hy_dict.model_kwargs)

t_model_kwargs = hy_dict.model_kwargs.copy()
t_model_kwargs["pretrained_model_name_or_path"] = "LongfeiHuang/SDMatte"
t_model = L(SDMatte)(**t_model_kwargs)
